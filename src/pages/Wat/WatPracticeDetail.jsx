...
const WatPracticeDetail = () => {
  ...
  const submitTestMutation = useWatTestSubmit();
  ...
  const handleSubmitTest = () => {
    // Map to backend WatAnswerDto format: { wordNo, word, sentence }
    const formattedAnswers = responses.map((r, index) => ({
      wordNo: r?.wordNo || index + 1,
      word: r?.word || "",
      sentence: r?.sentence || ""
    }));
    ...
    <section className="pt-24 py-10 bg-gray-50 min-h-screen">
      ...
      <div className="container mx-auto max-w-6xl px-4">
        ...
        <div className="mb-6 bg-red-600/10 border border-red-600/30 rounded-xl p-4 text-red-700 text-sm font-semibold">
          ❗ Speak your sentence or type it. Both will be analyzed.
        </div>
        ...
        {!isFinished ? (
            ...
            <div className="md:col-span-1 space-y-6">
              ...
              <div className="bg-white border rounded-xl shadow p-5 flex flex-col items-center justify-center">
                <div className="flex items-center gap-3 mb-2">
                  <Clock className={`w-8 h-8 ${timeLeft < 5 ? 'text-red-600 animate-pulse' : 'text-blue-600'}`} />
            ...
            <div className="md:col-span-2 space-y-6">
              ...
              <div className="bg-white border rounded-xl shadow p-6 relative">
                ...
                <div className="relative">
                  <textarea
                    className={`w-full p-4 pr-16 border rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent min-h-[100px] text-lg ${isListening ? 'border-red-400 shadow-[0_0_10px_rgba(248,113,113,0.3)]' : ''}`}
          ...
          <SrtAnalysisResult
            ...
            onBack={() => navigate("/wat")}
            backLabel="Back to WAT Tests"
            title="AI Analysis Report"
            breakdownTitle="Word-wise Breakdown"
            itemNumber="wordNo"
            itemLabel="word"
            itemFallback="Word"
            responseKey="sentence"
            responseLabel="Your Sentence"
            idealKey="improvedSentence"
            idealLabel="Ideal Sentence"
          />
        ) : (
          /* ✅ SUBMISSION SCREEN */
          <div className="mt-8 bg-white border rounded-xl shadow p-8 text-center max-w-2xl mx-auto">
            ...
            <p className="text-gray-600 mb-8">
              You have completed all {words.length} words. Click below to submit your sentences for AI analysis.
            </p>
